-- Prototype schema for Lift Log.
-- This version allows browser-based reads and writes for anon/authenticated roles.
-- That is convenient for development, but it is not appropriate for a public multi-user app
-- without adding stronger authorization rules.
